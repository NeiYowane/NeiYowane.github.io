        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop">
                <div class="left-header">
                    <!-- Logo desktop -->
                    <div class="logo">
                        <a href="index.php"><img src="media\images\logo-01.png" alt="IMG-LOGO"></a>
                    </div>
                </div>
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m h-full wrap-menu-click p-t-8">
                        <div class="h-full flex-m">
                            <div class="icon-header-item flex-c-m trans-04">
                                <img class="img-fluid" src="media\images\banner-mex.png" alt="MEX">
                            </div>
                        </div>

                        <div class="wrap-cart-header h-full flex-m m-l-10 menu-click">
                            <div class="icon-header-item flex-c-m trans-04">
                                <img class="img-fluid" src="media\images\banner-usa.png" alt="USA">
                            </div>
                        </div>
                    </div>
                </div>
