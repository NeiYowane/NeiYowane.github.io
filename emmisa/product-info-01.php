...
<html lang="en">
<head>
	<title>Información del Producto | Emmisa</title>
	<meta charset="UTF-8">
		...
		<div class="container">
			<div class="txt-center p-t-160 p-b-165">
				...
				<span class="txt-m-201 cl0 flex-c-m flex-w">
					...
					<a href="products.php" class="txt-m-201 cl0 hov-cl10 trans-04 m-r-6">
						/ Productos
					</a>

					<span>
						/ Cajas Regulares Laminadas con Impresión en Alta Grafica (Offset)
					</span>
				</span>
			</div>
		</div>
				...
				<div class="col-md-5 col-lg-6">
					<div class="p-l-70 p-t-35 p-l-0-lg">
						...
						<p class="txt-s-101 cl6">
							Resistencia (26ECT, 29ECT, 32ECT,40ECT).
							<br>
							Flautas (E,C y EE).
						</p>
					</div>
